...
const PaymentMethodOption = styled.div<{ selected: boolean }>`
  ...
  cursor: pointer;
  transition: all 0.3s ease;
  background: ${props => props.selected ? 'rgba(59, 130, 246, 0.05)' : 'var(--minimal-white)'};
  display: flex;
  ...
  &:hover {
    border-color: ${props => props.selected ? '#2563eb' : 'var(--minimal-gray-400)'};
...
const Checkout: React.FC = () => {
  ...
  const validateForm = () => {
    // Common required fields for both payment methods
    const commonRequired = ['email', 'firstName', 'lastName', 'country'];
    
    // Add payment-specific required fields
    const required = paymentMethod === 'card' 
      ? [...commonRequired, 'cardNumber', 'expiryDate', 'cvv', 'nameOnCard']
      : [...commonRequired, 'iban', 'accountHolderName'];
    ...
    <CheckoutWrapper>
      <Container>
        <CheckoutHeader>
          ...
          <CheckoutSubtitle>Complete your enrollment for premium Excel Data Visualization courses</CheckoutSubtitle>
        </CheckoutHeader>
          ...
          <CheckoutForm onSubmit={handleSubmit}>
                ...
                <PaymentMethodSelector>
                  ...
                  >
                    <PaymentMethodIcon 
                      ...
                      alt="SEPA Bank Transfer"
                    />
                    <PaymentMethodLabel>SEPA Bank Transfer</PaymentMethodLabel>
                  </PaymentMethodOption>
                </PaymentMethodSelector>
              </FormGroup>
                ...
                <>
                  ...
                  <div style={{
                    ...
                    <p style={{
                      ...
                      ℹ️ <strong>SEPA Direct Debit:</strong> By providing your IBAN, you authorize us to process payments via SEPA Direct Debit. 
            ...
            <BillingDescriptorSection>
              ...
              <BillingDescriptorText>
                Your credit card will be billed with the following descriptor: <strong>EXCEL.VISUAL-COURSES</strong>. This is how the charge will appear on the cardholder's billing statement.
              </BillingDescriptorText>
            </BillingDescriptorSection>
            ...
            <TermsCheckbox>
              <CheckboxContainer>
                ...
                <TermsText>
                  ...
                  I agree to pay the total amount provided on the checkout page. Upon successful payment, I will receive instant access to all Excel Data Visualization course materials. 
                  ...
                  Your credit card will be billed with the following descriptor: EXCEL.VISUAL-COURSES. This is how the 
                  charge will appear on the cardholder's billing statement. Excel course access will be provided immediately after successful payment.
                </TermsText>
              </CheckboxContainer>
            </TermsCheckbox>
          ...
          <OrderSummary>
            ...
            <OrderFeatures>
              <FeatureItem>
                ...
                <span>Instant access to Excel visualization courses</span>
              </FeatureItem>
              <FeatureItem>
                <FeatureIcon>🔒</FeatureIcon>
              ...
              <FeatureItem>
                ...
                <span>Lifetime access to dashboard templates</span>
              </FeatureItem>
              <FeatureItem>
                <FeatureIcon>📱</FeatureIcon>
                <span>Download Excel files on any device</span>
              </FeatureItem>
              <BillingInfo>
                <FeatureIcon style={{ marginTop: '2px' }}>💳</FeatureIcon>
                <div>
                  <strong style={{ color: 'var(--minimal-text-primary)' }}>Billing Descriptor:</strong><br />
                  Your credit card will be billed as <strong>EXCEL.VISUAL-COURSES</strong>. This is how the charge will appear on your billing statement.
                </div>
              </BillingInfo>
            </OrderFeatures>
          </OrderSummary>
