        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('EXCEL VISUALIZATION')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower business professionals worldwide with advanced Excel visualization education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform data into insightful charts, dashboards, and interactive visualizations.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted Excel courses cover advanced charting techniques, dynamic dashboards, interactive form controls, array functions, and professional visualization methods. Each course is designed with hands-on demos, real-world applications, and proven techniques to help you master Excel data visualization and advance your career as a data analyst or business intelligence professional.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Excel Visualization Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive Excel data visualization programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
          ...
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  <LeaderName>Excel Visualization Team</LeaderName>
                  <LeaderTitle>Excel Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about Excel data visualization and dedicated to making advanced Excel techniques accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of transforming data into powerful visual insights.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Excel Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in Excel data visualization education, constantly updating 
                  our curriculum with the latest charting techniques and business intelligence best practices.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Excel mastery should be accessible to everyone. We create a supportive environment 
                  where professionals from all backgrounds can master advanced visualization fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Excel Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest Excel features and visualization tools, 
                  bringing modern data presentation practices directly to our students.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(31)}>
                <ValueIcon>🛡️</ValueIcon>
                <ValueTitle>Clean Dashboard Design</ValueTitle>
                <ValueDescription>
                  We prioritize creating clean, professional dashboards, teaching not just how to 
                  build visualizations, but how to build them effectively and beautifully.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  Excel visualization is an evolving field. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical Excel skills that you can apply immediately 
                  in real projects, from financial dashboards to sales analytics and KPI tracking.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of data professionals with world-class Excel education, 
                practical visualization skills, and real-world dashboard projects that drive business intelligence success. 
                We believe that by making Excel data visualization accessible and excellent, we can help 
                students create powerful data insights while creating opportunities for everyone 
                to participate in the data-driven business revolution.
              </MissionStatementText>
            </MissionStatement>
          </ValuesContainer>
        </Container>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>Excel Data Visualization Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional Excel visualization experts is dedicated to 
            transforming business careers through comprehensive Excel data visualization education.
            <br /><br />
            We believe Excel mastery should be accessible to everyone, from complete beginners to advanced analysts looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex Excel visualization concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of Excel data visualization and empower them 
            with the knowledge and skills needed to create powerful dashboards and advance their careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your Excel visualization journey or looking to master advanced charting techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of Excel data visualization together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
