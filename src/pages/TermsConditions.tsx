    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the terms and provisions of this agreement. These terms apply to all digital visual courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This visual course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        <SectionTitle>3. Digital Visual Course Pricing</SectionTitle>
        <Paragraph>
          Our visual courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for visual course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "VISUAL COURSES" or "VISUAL-COURSES.COM". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased visual courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All visual course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our visual courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our visual course content to reflect the latest developments in design, creativity, and visual arts. 
      ...
      <Section>
        ...
        <Paragraph>
          {COMPANY_INFO.name} provides visual courses for educational purposes only. We make no guarantees about 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the laws of England and Wales. Any disputes will be resolved in the courts of England and Wales.
        </Paragraph>
      </Section>
