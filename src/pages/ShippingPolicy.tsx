...
const ShippingPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          {COMPANY_INFO.name} delivers visual courses digitally through our secure online learning platform. 
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Our visual courses are 100% digital products.</strong> There are no physical items to ship. All course materials, 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased visual courses. No waiting, no shipping delays - 
      ...
      <Section>
        ...
        <Paragraph>
          Our digital visual courses are available worldwide with internet access. There are no geographical restrictions 
