...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'Course Introduction', name: 'Course Introduction' },
    { id: 'Creative Charts', name: 'Creative Charts' },
    { id: 'Date Visualization', name: 'Date Visualization' },
    { id: 'Dynamic Charts', name: 'Dynamic Charts' },
    { id: 'Interactive Charts', name: 'Interactive Charts' },
    { id: 'Animated Charts', name: 'Animated Charts' },
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>Excel Data Visualization Course Collection</PageTitle>
          <PageSubtitle>Master advanced Excel charting and data visualization with our comprehensive course library covering interactive dashboards, dynamic charts, and professional visualization techniques</PageSubtitle>
        </PageHeader>
