...
const Account: React.FC = () => {
  ...
  const renderCoursesSection = () => {
    ...
    if (!isTestAccount) {
      return (
        <div>
          <SectionTitle>MY EXCEL COURSES</SectionTitle>
          
          <InfoCard>
            <EmptyOrdersText>
              📊 Your purchased EXCEL DATA VISUALIZATION courses will appear here after successful payment.
            </EmptyOrdersText>
            <EmptyOrdersText style={{ fontSize: '1rem', marginTop: '1rem', opacity: 0.8 }}>
              Once you purchase any Excel course, you'll have lifetime access to all course materials, 
              including videos, downloadable resources, and future updates.
            </EmptyOrdersText>
            <EmptyOrdersButtonWrapper>
              <ShoppingButton as={Link} to="/products" variant="primary">
                Browse Excel Courses
              </ShoppingButton>
            </EmptyOrdersButtonWrapper>
          </InfoCard>
        </div>
    ...
    // Courses for test account - advanced structure
    return (
      <div>
        <SectionTitle>MY EXCEL COURSES</SectionTitle>
        ...
        <div style={{ 
          ...
          }}>Continue your Excel Data Visualization mastery journey</p>
          <div style={{ 
            display: 'flex', 
