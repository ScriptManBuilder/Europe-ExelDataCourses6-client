...
const Home: React.FC = () => {
  ...
  const carouselSlides = [
    {
      title: "Why Choose Excel Data Visualization Academy?",
      subtitle: "Discover the excellence that makes our Excel training exceptional"
    },
    {
      title: "Expert-Led Excel Training",
      subtitle: "Learn from industry professionals with real-world data analysis and visualization experience"
    },
    {
      title: "Innovation Meets Excel",
      subtitle: "Where cutting-edge data visualization techniques meet practical Excel application"
    }
  ];
  ...
  const featuredSlides = [
    {
      title: "Featured Excel Data Visualization Courses",
      subtitle: "Discover our most popular and effective Excel training programs"
    },
    {
      title: "Revolutionary Learning",
      subtitle: "Next-generation Excel education that transforms data analysis skills"
    },
    {
      title: "Premium Excel Education",
      subtitle: "Crafted for those who demand excellence in data visualization mastery"
    }
  ];

  // Мемоизируем массив изображений для галереи
  const galleryImages = useMemo(() => {
    // Excel Data Visualization изображения для галереи
    const allImages = [
      { src: `/images/img_1.jpg`, alt: `Excel Portfolio 1`, type: 'excel-portfolio' },
      { src: `/images/img_2.jpg`, alt: `Excel Portfolio 2`, type: 'excel-portfolio' },
      { src: `/images/img_3.jpg`, alt: `Excel Portfolio 3`, type: 'excel-portfolio' },
      { src: `/images/img_4.jpg`, alt: `Excel Portfolio 4`, type: 'excel-portfolio' },
      { src: `/images/img_5.jpg`, alt: `Excel Portfolio 5`, type: 'excel-portfolio' },
      { src: `/images/img_6.jpg`, alt: `Excel Portfolio 6`, type: 'excel-portfolio' },
      { src: `/images/img_7.jpg`, alt: `Excel Portfolio 7`, type: 'excel-portfolio' },
      { src: `/images/img_8.jpg`, alt: `Excel Portfolio 8`, type: 'excel-portfolio' }
    ];
  ...
  const scrollingTexts = useMemo(() => [
    ...
    'FOLLOW US @VISUAL_COURSES',
    'PREMIUM EXCEL TRAINING COURSES',
    'TRANSFORM YOUR CAREER WITH EXCEL',
    'DATA ANALYSIS & VISUALIZATION',
    'JOIN THE EXCEL REVOLUTION NOW'
  ], []);
  ...
  return (
    <>
      <HeroSection>
        ...
        <Container>
          <HeroContent>
            <HeroTitle>EXCEL DATA VISUALIZATION</HeroTitle>
            <HeroSubtitle>
              Master Advanced Excel Techniques with Expert-Led Video Courses - Transform Your Data Analysis Skills Today
            </HeroSubtitle>
            <HeroButtons>
          ...
          <FeaturesGrid>
            <ScrollReveal ref={setScrollRevealRef(1)} delay={100}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Learn from industry professionals with hands-on data analysis and Excel experience and proven track records.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(6)} delay={600}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Cutting-edge curriculum updated regularly with the latest Excel developments and data visualization trends.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
          </FeaturesGrid>
      ...
      <VideoSection ref={videoSectionRef}>
        ...
        <VideoSectionContent>
          <VideoSectionTitle>Excel Learning in Action</VideoSectionTitle>
          <VideoSectionSubtitle>
            Experience the future of Excel education through interactive learning and real-world data visualization applications
          </VideoSectionSubtitle>
        </VideoSectionContent>
      </VideoSection>
      ...
      <InfoSection>
        <InfoGrid>
          <InfoBlock>
            ...
            <InfoDescription>
              Transform your data analysis career with comprehensive Excel training. 
              Learn charts, dashboards, pivot tables, Power Query, and advanced Excel techniques 
              that professionals use to create compelling, data-driven visualizations.
            </InfoDescription>
            ...
            <InfoSubsection>
              ...
              <InfoText>
                Master <InfoHighlight>advanced Excel visualization techniques </InfoHighlight> 
                 that deliver compelling, data-driven insights. From basic charts to 
                complex interactive dashboards, learn to create industry-standard visualizations.
              </InfoText>
            </InfoSubsection>
          </InfoBlock>
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              ...
              Our courses focus on real business scenarios and measurable improvements in data analysis.
            </InfoDescription>
            ...
            <InfoSubsection>
              ...
              <InfoText>
                ...
                top data analysts and business intelligence professionals. From data preparation to final dashboard, 
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              ...
              Stay ahead of the rapidly evolving data visualization industry with continuous learning.
            </InfoDescription>
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              ...
              Get answers to your questions and accelerate your data visualization learning journey.
            </InfoDescription>
            ...
            <InfoSubsection>
              ...
              <InfoText>
                ...
                and collaborate on data visualization projects.
              </InfoText>
            </InfoSubsection>
          </InfoBlock>
        </InfoGrid>
