    ...
    <Container>
      ...
      <Section>
        <Paragraph>
          ...
          This policy explains our approach to visual course returns and refunds for digital educational content.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          Our visual courses are digital products delivered instantly upon purchase. Due to the nature of digital 
      ...
      <Section>
        ...
        <Paragraph>
          Since our visual courses are delivered digitally through your online account, there are no physical items to return. 
      ...
      <Section>
        ...
        <Paragraph>
          Instead of returns, we offer a 7-day satisfaction guarantee on all visual course purchases. You may request a full refund 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your visual course:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit to switch to a different visual course<br/>
      ...
      <Section>
        ...
        <Paragraph>
          If you're not satisfied with your current course but would like to try a different visual course from our collection, 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          and improvements. This ensures ongoing value for your investment in visual education.
        </Paragraph>
      </Section>
