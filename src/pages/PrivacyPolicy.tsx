    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          through our visual course platform or communicate with us (collectively referred to as the "Services"). 
        ...
        <Paragraph>
          Any personal information we collect is used exclusively for providing our visual course services and 
      ...
      <Section>
        ...
        <Paragraph>
          We collect personal information from various sources to provide our visual course Services. 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          browsing activity on the Site. This data helps us understand how users interact with our visual courses 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          Advertisers or marketing partners who help us reach you with relevant Excel Data Visualization course promotions.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          <strong>Marketing and Advertising:</strong> Send you promotional communications about new visual courses 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          With marketing partners who may use your data for targeted visual course ads or promotions.<br/>
      ...
      <Section>
        ...
        <Paragraph>
          Our visual course Services are not intended for children, and we do not knowingly collect information 
      ...
      <Section>
        ...
        <Paragraph>
          If you are outside the UK, please note that your personal data may be transferred to and 
          processed in the United Kingdom. We take appropriate steps to ensure that your information is 
