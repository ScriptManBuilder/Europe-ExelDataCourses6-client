...
const ProductsDropdown: React.FC<ProductsDropdownProps> = ({ 
  ...
  const categories = [
    { id: 1, name: 'Course Overview', icon: '📊', productId: 1 },
    { id: 2, name: 'Dynamic Charts', icon: '⚡', productId: 4 },
    { id: 3, name: 'Interactive Controls', icon: '🎮', productId: 5 },
    { id: 4, name: 'Complete Mastery', icon: '🏆', productId: 11 },
  ...
  return (
    ...
    >
      <DropdownContent>
        ...
        <FeaturedSection>
          <FeaturedTitle>Featured Excel Visualization Courses</FeaturedTitle>
          <ProductGrid>
